    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          require('config.php');
					...
					if(isset($_POST["voterName"]) && isset($_POST["voterEmail"]) && isset($_POST["voterID"]) && isset($_POST["aadharID"]) && isset($_POST["selectedCandidate"]))
					{
						$name= test_input($_POST["voterName"]);
						$email= test_input($_POST["voterEmail"]);
						$voterID= test_input($_POST["voterID"]);
                                                $aadharID= test_input($_POST["aadharID"]);
       ...
       $DB_NAME="db_evoting";
        ...
        or die("Couldn't Connect to Database :");
				...
				$sql= "INSERT INTO db_evoting.tbl_users VALUES(null,'".$name."','".$email."','".$voterID."','".$aadharID."','".$selection."');";
